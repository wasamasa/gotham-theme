...
(gotham-set-faces
 '((default :foreground base6 :background base0)
   ...
   (diredp-compressed-file-suffix :foreground orange)
   (diredp-date-time :foreground cyan)
   (diredp-deletion :foreground yellow :background red)
   (diredp-deletion-file-name :foreground red)
   (diredp-dir-heading :foreground yellow :background base3)
   (diredp-dir-name :foreground base7 :background base2)
   (diredp-dir-priv :foreground base7 :background base2)
   (diredp-exec-priv :background orange)
   (diredp-executable-tag :foreground red)
   (diredp-file-name :foreground yellow)
   (diredp-file-suffix :foreground green)
   (diredp-flag-mark :foreground base3 :background yellow)
   (diredp-flag-mark-line :background red)
   (diredp-ignored-file-name :foreground green)
   (diredp-link-priv :foreground magenta)
   (diredp-mode-line-flagged :foreground red)
   (diredp-mode-line-marked :foreground violet)
   (diredp-no-priv :foreground base3)
   (diredp-number :foreground orange)
   (diredp-other-priv :background base2)
   (diredp-rare-priv :foreground green :background base3)
   (diredp-read-priv :background base2)
   (diredp-symlink :foreground blue)
   (diredp-write-priv :foreground base7 :background green)
