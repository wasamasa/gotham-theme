...
(gotham-set-faces
 '((default :foreground base6 :background base0)
   ...
   (helm-ff-directory :foreground base5)
   (helm-ff-dirs :foreground yellow)
   (helm-ff-dotted-directory :foreground orange)
   (helm-ff-dotted-symlink-directory :foreground red)
   (helm-ff-executable :foreground base5)
   (helm-ff-file :foreground base6)
   (helm-ff-invalid-symlink :foreground base2 :background red)
   (helm-ff-prefix :foreground base2 :background yellow)
   (helm-ff-symlink :foreground base6)
   ...
   (helm-header :background base0 :foreground base5)
   (helm-history-deleted :foreground base1 :background red)
   ...
   (helm-selection :background base3)
   (helm-selection-line :inherit highlight)
   (helm-separator :inherit shadow)
   (helm-source-header :foreground base7 :weight bold)
   (helm-time-zone-current :foreground base7)
   (helm-time-zone-home :foreground red)
   (helm-visible-mark :background base2 :foreground yellow)
